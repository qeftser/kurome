...
def generate_launch_description():
    ...
    default_rviz_config_path = os.path.join(pkg_share, 'config/sim0_config.rviz')
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.ExecuteProcess(cmd=['gazebo', '--verbose', '-s', 'libgazebo_ros_init.so', '-s', 'libgazebo_ros_factory.so', os.path.join(pkg_share,'config/empty.sdf')], output='screen'),
