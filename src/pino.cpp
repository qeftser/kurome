...
public:
   ...
   Pino() : Node("pino") {
      ...
      this->declare_parameter("lidar_acceptance_threshold",0.3); /* probability */
      ...
      /* parameters specifically for the builtin graph slam algorithm */
      this->declare_parameter("recent_length",7);
      this->declare_parameter("loop_closure_dist",1);
